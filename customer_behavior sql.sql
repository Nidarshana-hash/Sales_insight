...
select item_purchased,avg(review_rating) as rr
from customer
...
select subscription_status,count(customer_id) as total_customer,round(avg(purchase_amount),2) as average_spending,sum(purchase_amount) as total_revenue
from customer
